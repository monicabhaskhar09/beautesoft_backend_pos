    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_havechild', models.BooleanField(db_column='item_haveChild', null=True)),
                ('value_applytochild', models.BooleanField(db_column='Value_ApplyToChild', null=True)),
                ('package_disc', models.FloatField(blank=True, db_column='Package_Disc', null=True)),
                ('have_package_disc', models.BooleanField(db_column='Have_Package_Disc', null=True)),
                ('pic_path', models.CharField(blank=True, db_column='PIC_Path', max_length=255, null=True)),
                ('item_foc', models.BooleanField(db_column='Item_FOC', null=True)),
                ('item_uom', models.CharField(blank=True, db_column='Item_UOM', max_length=20, null=True)),
                ('mixbrand', models.BooleanField(db_column='MIXBRAND', null=True)),
                ...
                ('autocustdisc', models.BooleanField(db_column='AutoCustDisc', null=True)),
                ...
                ('voucher_value_is_amount', models.BooleanField(db_column='Voucher_Value_Is_Amount', null=True)),
                ...
                ('is_gst', models.BooleanField(db_column='IS_GST', null=True)),
                ...
                ('is_open_prepaid', models.BooleanField(db_column='IS_OPEN_PREPAID', null=True)),
                ...
                ('service_cost_percent', models.BooleanField(db_column='Service_Cost_Percent', null=True)),
                ('account_code_td', models.CharField(blank=True, db_column='Account_Code_TD', max_length=20, null=True)),
                ('voucher_isvalid_until_date', models.BooleanField(db_column='Voucher_IsValid_Until_Date', null=True)),
                ('voucher_valid_until_date', models.DateTimeField(blank=True, db_column='Voucher_Valid_Until_Date', null=True)),
                ('workcommholder', models.CharField(blank=True, max_length=6, null=True)),
                ('equipmentcost', models.FloatField(blank=True, null=True)),
                ('postatus', models.BooleanField(blank=True, null=True)),
                ('gst_item_code', models.CharField(blank=True, db_column='GST_Item_Code', max_length=20, null=True)),
                ('is_have_tax', models.BooleanField(db_column='IS_HAVE_TAX', null=True)),
                ('sst_item_code', models.CharField(blank=True, db_column='SST_Item_Code', max_length=20, null=True)),
                ('is_allow_foc', models.BooleanField(db_column='IS_ALLOW_FOC', null=True)),
                ...
                ('istnc', models.BooleanField(blank=True, db_column='isTnc', null=True)),
                ('voucher_template_name', models.CharField(blank=True, db_column='Voucher_Template_Name', max_length=50, null=True)),
                ('autoproportion', models.BooleanField(db_column='AutoProportion', null=True)),
                ('item_pingying', models.CharField(blank=True, db_column='Item_PingYing', max_length=250, null=True)),
                ('process_remark', models.CharField(blank=True, db_column='Process_Remark', max_length=250, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('sutiable_for', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('pinyin', models.CharField(blank=True, db_column='Pinyin', max_length=500, null=True)),
                ('item_seq', models.IntegerField(default=1, null=True)),
                ('item_price_ceiling', models.FloatField(blank=True, db_column='Item_Price_Ceiling', null=True)),
                ...
                ('autoappointment', models.BooleanField(blank=True, db_column='Autoappointment', null=True)),
