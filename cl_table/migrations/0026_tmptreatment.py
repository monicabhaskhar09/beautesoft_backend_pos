# Generated by Django 3.0.7 on 2023-07-17 12:49
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cl_table', '0025_auto_20230717_1248'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.CharField(blank=True, db_column='Course', max_length=280, null=True)),
                ...
                ('lpackage', models.BooleanField(blank=True, db_column='lPackage', null=True)),
                ...
                ('newservice_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='cl_table.Stock')),
                ('treatment_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='cl_table.Treatment')),
            ],
            options={
