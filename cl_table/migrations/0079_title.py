...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cl_table', '0078_appointmentdetails'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trans_footer5', models.CharField(blank=True, db_column='Trans_Footer5', max_length=500, null=True)),
                ('trans_footer6', models.CharField(blank=True, db_column='Trans_Footer6', max_length=500, null=True)),
                ...
                ('license_key', models.CharField(blank=True, db_column='license_key', max_length=200, null=True)),
                ('valid_date', models.DateField(blank=True, null=True)),
                ('version_no', models.CharField(blank=True, db_column='version_no', max_length=200, null=True)),
